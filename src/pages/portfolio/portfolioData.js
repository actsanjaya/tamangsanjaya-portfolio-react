export const portfolioData = {
  hero: {
    ...
    description:
      'I help insurance and financial teams turn complex data into reliable insights through actuarial analysis, data analysis, and automation. I build efficient solutions with Python, SQL, Power BI, and Advanced Excel to drive accuracy, efficiency, and better decisions.',
    badges: ['Actuarial Expertise', 'Automation Focused', 'Data Driven'],
    summaryMetrics: [
      { label: 'Core stack', value: 'Python / SQL / Power BI' },
      { label: 'Focus', value: 'Valuation and reporting' },
      { label: 'Direction', value: 'Automation-first workflows' },
    ],
  },
  about: {
    title: 'About Me',
    heading: 'Technical actuarial work with a practical systems mindset.',
    text: 'I am a detail-oriented actuarial professional with a strong technical foundation in data analysis, modeling, reporting workflows, and automation. I specialize in building reliable actuarial solutions that improve accuracy, reduce manual effort, and support better business decisions.',
    highlights: [
  ...
  skills: [
    ...
    },
    {
      ...
      accent: 'Decision outputs',
      items: ['Python', 'SQL', 'Power BI', 'Advanced Excel', 'Dashboarding'],
    },
    {
      group: 'Systems and automation',
      accent: 'Repeatable workflows',
      items: [
        'Automation',
        'Reporting Pipelines',
        'RAG / AI Assistant Concepts',
        'Excel Modelling',
        'Workflow Design',
      ],
    },
  ...
  experience: [
    ...
    {
      company: 'Nepal Insurance Company Limited',
      role: 'Intern',
  ...
  certificationSection: {
    eyebrow: 'Actuarial Certifications',
  },
  certifications: [
    {
    ...
    {
      title: 'CM1 - Actuarial Mathematics',
    },
    {
  ...
  modelSection: {
    eyebrow: 'Model Lab',
    title: 'Run the models, not just read about them.',
    subtitle:
      'Actuarial models built in Python and rebuilt for the browser, so anyone can change an assumption and watch the numbers move.',
    ctaLabel: 'Open the Model Lab',
  },
  contactSection: {
    eyebrow: 'Contact',
    title: 'Clear ways to connect.',
    subtitle:
      'Use Gmail in the browser, copy direct contact details, or connect through LinkedIn. No default desktop mail app is required.',
  },
}
